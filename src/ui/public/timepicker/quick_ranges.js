...
module.constant('quickRanges', [
  ...
  { from: 'now/d',    to: 'now',      display: '截至今天',        section: 0 },
  { from: 'now/w',    to: 'now',      display: '本周至今',          section: 0 },
  { from: 'now/M',    to: 'now',      display: '本月至今',         section: 0 },
  { from: 'now/y',    to: 'now',      display: '今年至今',          section: 0 },
